...
class AppComponent extends React.Component {
  ...
  render() {
    const { actions, system, snackbar, socketStatus, ballroom} = this.props;
    ...
    return (
      ...
      ? (
        ...
        <Main system={system} actions={actions} snackbar={snackbar} socketStatus={socketStatus} ballroom={ballroom} />
      )
    );
  }
}
