...
class App extends Component {
  render() {
    const {actions, stuff, system, socketStatus, snackbar, ballroom} = this.props;
    return (
      <Main
        actions={actions}
        stuff={stuff}
...
App.propTypes = {
  actions: PropTypes.shape({
    ...
    chooseShip: PropTypes.func.isRequired,
    pullItem: PropTypes.func.isRequired,
    activateAnsible: PropTypes.func.isRequired,
    sendToOutroVideo: PropTypes.func.isRequired
  }),
  stuff: PropTypes.shape({}),
  system: PropTypes.shape({}),
  socketStatus: PropTypes.shape({}),
  snackbar: PropTypes.shape({}),
  ballroom: PropTypes.shape({})
};
